    ...
    : QObject(parent)
{
    ...
    //更新了设备列表
    connect(this, &ARDevice::inputDeviceInfosUpdated,
            this, &ARDevice::setInputDeviceInfos);
    connect(this, &ARDevice::outputDeviceInfosUpdated,
            this, &ARDevice::setOutputDeviceInfos);
    //延时刷新
    updateTimer.setSingleShot(true);
    connect(&updateTimer, &QTimer::timeout, this, &ARDevice::updateDeviceInfos);
...
void ARDevice::setInputDeviceNames(const QStringList &names)
{
...
void ARDevice::setOutputDeviceNames(const QStringList &names)
{
...
bool ARDevice::setCurrentInputName(const QString &name)
{
...
bool ARDevice::setCurrentInputIndex(int index)
{
...
void ARDevice::resetCurrentInput()
{
    currentInputDeviceInfo = QAudioDeviceInfo::defaultInputDevice();
}

QAudioDeviceInfo ARDevice::getInputInfo(const QString &name) const
{
...
bool ARDevice::setCurrentOutputName(const QString &name)
{
...
bool ARDevice::setCurrentOutputIndex(int index)
{
...
void ARDevice::resetCurrentOutput()
{
    currentOutputDeviceInfo = QAudioDeviceInfo::defaultOutputDevice();
}

QAudioDeviceInfo ARDevice::getOutputInfo(const QString &name) const
{
...
void ARDevice::setInputDeviceInfos(const QList<QAudioDeviceInfo> &infos)
{
...
void ARDevice::setOutputDeviceInfos(const QList<QAudioDeviceInfo> &infos)
{
...
bool ARDevice::nativeEventFilter(const QByteArray &eventType, void *message, long *result)
{
    Q_UNUSED(result);
...
void ARDevice::updateDeviceInfos()
{
